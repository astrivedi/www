...
FileUtils.cp(File.join(SRC,'assets/img/portrait.jpg'), File.join(OUT,'assets/img/portrait.jpeg'))
...
<img src="/assets/img/portrait.jpeg" width="170" height="170" alt="Portrait of Ashutosh Trivedi" fetchpriority="high">
</section>
